module identity.module {
    ...
    opens identity.module.repository.entities;
    //opens identity.module.repository.entities to identity.module.test, org.hibernate.orm.core, ALL-UNNAMED;
    opens identity.module.enums to identity.module.test;
    exports identity.module.models to com.fasterxml.jackson.databind;
    exports identity.module to org.apache.tomcat.embed.core;
